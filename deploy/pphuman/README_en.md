...
- For details, please refer to [Cross-Camera Tracking](docs/mtmct.md)
...
- For details, please refer to [Attribute Recognition](docs/attribute.md)

### 5. Behavior Recognition
- Use PP-YOLOE + Bytetrack to track humans
- Use HRNet for keypoint detection and get the information of the 17 bone points in the human body
- According to the changes of the bone points of the same person within 100 frames, judge whether the action made by the person within 100 frames is a fall with the help of ST-GCN
- For details, please refer to [Behavior Recognition](docs/action.md)
